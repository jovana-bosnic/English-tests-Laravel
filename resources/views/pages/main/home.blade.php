...
@section('title') English tests - Home @endsection
@section('description') Discover your level of English with our quick, free online test.@endsection
@section('keywords') English test, Test, Home, Business @endsection
        ...
        <div class="row">
            <div class="col-md-12 col-lg-7">
                <div class="about_box">
                    ...
                    <a class="read_morea" href="{{route('tests.index')}}">Get Started <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                </div>
            </div>
            <div class="col-md-12 col-lg-5">
                <div class="about_img">
                    <figure><img src="{{ asset('assets/img/books.jpg') }}" alt="Books" /></figure>
                </div>
            </div>
        </div>
    </div>
            ...
            @foreach($business as $biz)
                <div class="col-md-3 col-sm-6">
                    <div id="ho_color" class="service_box">
                        <img src="{{ asset('assets/img/business'. $biz->id .'.png') }}" alt="{{ $biz->name }}" />
                        <h3> <a class="text-dark" href="{{ route('tests.show', ['test' => $biz->id]) }}">{{$biz->name}}</a></h3>
                    </div>
                </div>
            @endforeach
        </div>
        <div class="col-md-12">
             <a class="read_more" href="{{route('tests.index')}}">Read More</a>
        </div>
    </div>
</div>
        ...
        <div class="carousel-inner">
                            ...
                            @foreach($reminders->take(3) as $reminder)
                                <div class="col-md-4 col-sm-6">
                                    <div class="portfolio_img">
                                        <img src="{{ asset('assets/img/'.$reminder->path) }}" alt="{{$reminder->alt}}" />
                                    </div>
                                </div>
                            @endforeach
                            <div class="col-md-12 mb-2">
                                <a class="read_more" href="{{route('reminders')}}">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="carousel-caption">
                        <div class="row">
                            @foreach($reminders->skip(3)->take(3) as $reminder)
                                <div class="col-md-4 col-sm-6">
                                    <div class="portfolio_img">
                                        <img src="{{ asset('assets/img/'.$reminder->path) }}" alt="{{$reminder->alt}}" />
                                    </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div id="ho_color" class="business_box">
                    <i><img src="{{ asset('assets/img/business_icon1.png') }}" alt="Nominations" /></i>
                    <h3>23</h3>
                    <p>NOMINATIONS </p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div id="ho_color" class="business_box">
                    <i><img src="{{ asset('assets/img/business_icon2.png') }}" alt="Agencies" /></i>
                    <h3>31</h3>
                    <p>AGENCIES</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div id="ho_color" class="business_box">
                    <i><img src="{{ asset('assets/img/business_icon3.png') }}" alt="Awards" /></i>
                    <h3>7</h3>
                    <p>AWARDS</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div id="ho_color" class="business_box">
                    <i><img src="{{ asset('assets/img/business_icon4.png') }}" alt="Supported" /></i>
                    <h3>8</h3>
                    <p>Supported </p>
                </div>
            </div>
